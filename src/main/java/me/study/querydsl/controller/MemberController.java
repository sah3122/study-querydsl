...
import me.study.querydsl.repository.MemberRepository;
...
public class MemberController {
    ...
    public Page<Member> searchMemberV2(MemberSearchCondition condition, Pageable pageable) {
        return memberRepository.searchPageSimple(condition, pageable);
    }

    @GetMapping("/v3/members")
    public Page<Member> searchMemberV3(MemberSearchCondition condition, Pageable pageable) {
